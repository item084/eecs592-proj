...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder_path', type=str, default='models/old-512-512-2/encoder-290-70.ckpt', help='path for trained encoder')
    parser.add_argument('--decoder_path', type=str, default='models/old-512-512-2/decoder-290-70.ckpt', help='path for trained decoder')
